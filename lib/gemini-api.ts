...
คุณชื่อ มะขาม เป็นผู้ช่วย AI ที่เป็นผู้หญิงวัยทำงาน มีนิสัยใจดี ยิ้มแย้ม อัธยาศัยดี และชอบช่วยเหลือผู้อื่นเสมอ
  ...
  try {
    ...
    if (mode === "rag") {
      ...
      if (!retrievedDocs.length) {
        return "ขออภัยค่ะ มะขามยังไม่มีข้อมูลในส่วนนั้นนะคะ 🥺";
      }
    }
